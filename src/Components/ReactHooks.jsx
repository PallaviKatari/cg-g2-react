...
export default function ReactHooks() {
    ...
    return (
        <div style={{ marginTop: 100 }}>
            ...
            <button onClick={addProject} style={{ marginTop: 30, width: 100 }}>Add Project</button>
            <hr></hr>
            <Effect />
            <hr></hr>
            <Effect1 />
    ...
    return (
        <div>
            ...
            <input
                ...
                style={{ marginTop: 30, width: 100, marginLeft: 700, borderStyle: 'dashed', borderColor: 'black' }}></input>
        </div>
    );
}
    ...
    return (
        <form>
            ...
            <input
                ...
                style={{ marginTop: 30, width: 100, marginLeft: 680, borderStyle: 'dashed', borderColor: 'black' }}
            />
